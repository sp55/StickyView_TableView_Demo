...
- (void)viewDidLoad {
    ...
    self.headerView = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 80)];
    ...
    //固定的view
    self.stickyView = [[UILabel alloc] initWithFrame:CGRectMake(0, self.headerView.bottomY, kScreenWidth, 50)];
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.stickyView.bottomY, kScreenWidth, self.view.height - self.stickyView.bottomY)];
